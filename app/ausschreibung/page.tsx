    ...
    <div style={{ fontFamily: "Lato, sans-serif", background: BG, color: "#111" }}>
      ...
      <header className="p1-topbar">
        ...
        >
          ...
          >
            <a className="p1-navlink" href="/">
              Home
            </a>
            <a className="p1-navlink" href="/ausschreibung">
              Ausschreibung
            </a>
            <a className="p1-navlink" href="/register">
              Registrierung
            </a>
            <a className="p1-navlink" href="/leaderboard">
              Leaderboard
            </a>
            <a className="p1-navlink" href="/#partners">
              Partner
            </a>
          </nav>
