...
export default function ScoreEntryMask() {
  ...
  useEffect(() => {
    ...
    async function loadScores() {
      ...
      const { data, error } = await supabase
        .from("scores")
        .select("player_id, hole_number, strokes, tournament_id")
        .eq("tournament_id", TOURNAMENT_ID)
  ...
  if (player && (player as any).holes) {
    setHoleCount((player as any).holes);
  } else {
    setHoleCount(18);
  }
  ...
  async function saveScores() {
    ...
    if (error) {
      ...
      setMessage("Scores erfolgreich gespeichert.");
    }
      ...
      <div className="mx-auto max-w-5xl space-y-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                Spieler nach Namen suchen, Scores eintragen und direkt speichern.
              </p>
            </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  {selectedPlayer ? fullName(selectedPlayer) : "Noch kein Spieler ausgewählt"}
                </p>
              </div>
              <button
                type="button"
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Die Maske speichert per Upsert. Bestehende Scores werden überschrieben, neue automatisch angelegt.
            </p>
            ...
            >
              ...
              {saving ? "Speichert ..." : "Scores speichern"}
            </button>
